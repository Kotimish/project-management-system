...
from src.monolith.config.settings import settings
...
from monolith.project.infrastructure import models as project_models
# all target metadata
all_target_metadata = [
    auth_models.Base.metadata,
    user_profile_models.Base.metadata,
    project_models.Base.metadata
]
...
if context.is_offline_mode():
    raise NotImplementedError("Offline mode is not supported with multiple schemas.")
